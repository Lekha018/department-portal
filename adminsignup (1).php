...
<body>
    <div class = "signup">
        ...
        <p style="text-align: center; padding-top: 20px; font-size: 15px;";>Have an account already? <a href="adminpanel.php">Login Here!</a></p>
    </div>
    <div class="sidebar"> 
        <div>
            <ul>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO adminlogin (first_name, last_name, con_number, reg_no, user, pass) 
