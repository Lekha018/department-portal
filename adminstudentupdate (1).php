...
if(isset($_POST["update"])) {
    ...
    try {
        ...
        $stmt = $db->prepare("UPDATE register SET first_name = ?, last_name = ?, address = ?, con_number = ?, year = ?, cgpa = ?, fmobile = ?, mmobile = ? WHERE reg_no = ?");
        $stmt->execute([$first_name, $last_name, $address, $con_number, $year, $cgpa, $fmobile, $mmobile, $reg_no]); // Update other fields as needed
