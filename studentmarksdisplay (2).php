...
if(isset($_SESSION['sess_user'])) {
    ...
    $query = "SELECT first_name, last_name, reg_no, marks_subject1, marks_subject2, marks_subject3, marks_subject4, marks_subject5, sub1,sub2,sub3,sub4,sub4,sub5 , s1,s2,s3,s4,s5 FROM admin WHERE first_name = '$student_name'";
