...
$query = "SELECT first_name,last_name,reg_no,dept, journalpaper, conferencepaper, awards,coursesandcertification FROM `facultyachievements` WHERE first_name = '$sessionUser'";
