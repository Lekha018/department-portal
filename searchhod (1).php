...
if(isset($_POST["search"])) {
    ...
    $stmt = $db->prepare("SELECT * FROM `hod database` WHERE reg_no = ?");
    $stmt->execute([$reg_no]);
    ...
    if($student) {
        ...
        <div>
            <ul>
                ...
                <li>
                    <div class="logo-text-container">
                        ...
                        <a href="hodpersonaledit.php" class="logo-text">Back</a>
                    </div>
                </li>
                <li>
                    <div class="logo-text-container">
            ...
            <div class="form-container">
                <h1>Edit Hod Record</h1>
                <form action="hodpersonalupdate.php" method="POST">
                    ...
                    <input type="text" id="age" name="age" value="<?php echo $student['age']; ?>" required>
                    <label for="research">Research:</label>
                    <input type="text" id="research" name="research" value="<?php echo $student['research']; ?>" required>
                    <label for="interest">Interest:</label>
                    <input type="text" id="interest" name="interest" value="<?php echo $student['interest']; ?>" required>
